                ...
                <div class="tab-content row justify-content-center" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div role="tabpanel" class="col-lg-9 tab-pane fade show active" id="day-1">
                        ...
                        <div class="row schedule-item">
                            ...
                            <div class="col-md-10">
                                <h4>{{$pendaftar->daftar_nama}}</h4>

                            </div>
                        </div>
                        <div class="row schedule-item">
                            <div class="col-md-2"><time>Tanggal</time></div>
                            <div class="col-md-10">
                        ...
                        <div class="row schedule-item">
                            <div class="col-md-2"><time>Waktu</time></div>
                            <div class="col-md-10">
                                @if ($pendaftar->jadwal == null)
                                    <h4>Permohonan anda belum diproses.</h4>
                                @else                                
                        ...
                        <div class="row schedule-item">
                            ...
                            <div class="col-md-10">
                                <h4>{{$pendaftar->kecamatan->kecamatan_nama}}</h4>

                            </div>
                        </div>
                        <div class="row schedule-item">
                            <div class="col-md-2"><time>Lokasi</time></div>
                            <div class="col-md-2">
                                <h4>{{$pendaftar->lokasi->lokasi_nama}}</h4>
                            </div>
                        </div>
                        ...
                        <div class="row schedule-item">
                            ...
                            <div class="col-md-10">
                                <h4>PELAYANAN AKAN DILAKUKAN APABILA SUDAH MENCAPAI / MELEBIHI KUOTA LAYANAN SEBESAR {{$pendaftar->kecamatan->kecamatan_target}}
                                    LAYANAN</h4>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="keranjang.html">
                            ...
                            <div class="form-group mt-3">
                                <input type="text" class="form-control" name="your-alamat"
                            ...
                            <div class="form-group mt-3 mb-2 row">
                                ...
                                <div class="col col-lg-3">
                                    <input type="text" class="form-control text-center" name="your-alamat"
